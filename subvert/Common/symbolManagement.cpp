...
std::vector<std::basic_string<TCHAR>> GetRequireSymbolNames()
{
	...
	std::vector<std::basic_string<TCHAR>> forAll = {
		...
		TEXT("ntoskrnl!DbgkForwardException"),
		TEXT("ntoskrnl!DbgkpMarkProcessPeb"),
		TEXT("ntoskrnl!ObpCallPreOperationCallbacks"),
		TEXT("ntoskrnl!ObpCallPostOperationCallbacks"),
		TEXT("ntoskrnl!PspNotifyEnableMask"),
		TEXT("ntoskrnl!PsGetNextProcessThread"),
		TEXT("ntoskrnl!SwapContext"),
	};
