...
const WCHAR *GameName = L"dnf.exe";//演示进行注入的游戏，演示自然要找最强的
//
...
//				//printf("find pid= %d\r\n", pid);
//				//其他处理代码！
//				inject_dll(pid, L"C:\\ass.dll");//终极注入一秒刷爆
//				m_ProcessList[pid] = 2;
//			}
//		}
//		Sleep(5000);
...
DWORD WINAPI SocketRoutine(PVOID _param)
{
	network::init_srv();
	return 0;
}
